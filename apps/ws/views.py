...
def view_cliente_contrato_ajax(request,contrato,digito):
	if request.method == "GET":
		data = serializers.serialize("json",Cliente.objects.filter(status=True,Contrato=contrato,Dig_verf=digito))
